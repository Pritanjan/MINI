    ...
    def FRM1():
        ...
        def FRMS():
            ...
            def searchTBS(a1,a2):
                ...
                fin=open(r'STATION CODE\STATION CODE.txt','r')
                abc=fin.read()
        ...
        def FRMP():
            ...
            def check(a):
                ...
                if a != '':
                    ...
                    lb.pack()
            def show(a):
                fin=open(r'PASSENGER\PASSENGER.txt','r')
                i=fin.readline()
                while i:
                    ls=i.split(',')
                    if a==ls[0]:
        ...
        def FRMT():
            ...
            def getsch(a1,a2):
                a1=a1.get().strip().upper()
                a2=a2.get().strip().upper()
                fin=open(r'TRAIN CODE\TRAIN CODE.txt','r')
                abc=fin.read()
                    ...
                    if a8==''or a8 not in ['1A','2A','3A','SL']:
                        ...
                        if x[0][ind]>=p[ind]:
                            ...
                            while True:
                                ...
                                f=open(r'PNRS\PNRS.txt','r')
                                if str(pnr) not in f.read():
                                    f.close()
                                    f=open(r'PNRS\PNRS.txt','a')
                                    f.writelines('\n'+str(pnr))
                                    f.flush()
                                    break
                            fin=open(r'PASSENGER\PASSENGER.txt','a')
                            txt=str(pnr)+','+a1+','+a2+','+a3+','+a4+','+a5+','+a6+','+a7+','
                            txt=txt+a8+','+a9+'-'+a10+'-'+a11+'\n'
                            fin.write(txt)
                            fin.close()
                            pth=r'TRAINS\%s.txt'%y
                            fin=open(pth,'r+')
                            f2=open(r'TRAINS\temp.txt','w')
                            i=fin.readline()
                            ctr=0
                            while i:
                            ...
                            f2.close()
                            os.remove(pth)
                            os.rename(r'TRAINS\temp.txt',pth)
...
w1.geometry(size)
ph=ImageTk.PhotoImage(Image.open('PHOTOS\welcome.png'))
...
def pw_frame():
    ...
    btn.pack()
def check(a1,a2):
    fin=open(r'PASSWORD\PASSWORD.txt')
    a1=a1.get()
    a2=a2.get()
